...
export class AppComponent {
  ...
  public listOfTestsResults: Array<TestResult> = [
    new TestResult("Fusion FCC Eagle Nighly", "Master", "3866", "28.06.2022  02:06"),
    new TestResult("Fusion FCC SeaCloud Nightly", "Release/MSM_r2022_1_candidate", "3866", "28.06.2022  02:06"),
    new TestResult("Fusion FCC FPM Nightly", "Release/MSM_r2022_1_candidate", "3866", "28.06.2022  02:06"),
    new TestResult("Fusion FCC SeaCloud Daily", "Release/MSM_r2022_1_candidate", "3866", "28.06.2022  02:06")
  ];
